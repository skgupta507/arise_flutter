...
class _SettingsScreenState extends State<SettingsScreen> {
      ...
      builder: (_) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            Text('What\'s new:', style: TextStyle(fontFamily:'Rajdhani',
              fontWeight:FontWeight.w700, color: isDark ? AriseColors.demonText : AriseColors.angelText)),
        ...
        actions: [
          TextButton(
            ...
            child: Text('Later', style: TextStyle(color: isDark ? AriseColors.demonMuted : AriseColors.angelMuted)),
          ),
          ElevatedButton(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: bg,
        title: Text('Settings', style: TextStyle(fontFamily:'Orbitron', color:accent, fontSize:16)),
      ),
      body: ListView(
        ...
        children: [
          ...
          GridView.count(
            shrinkWrap: true, crossAxisCount: 2, mainAxisSpacing: 10, crossAxisSpacing: 10,
          ...
          _SettingsCard(isDark: isDark, children: [
            _SwitchRow(
              ...
              label:   isDark ? 'Switch to Light ✨ Angel Theme' : 'Switch to Dark 🔥 Demon Theme',
              desc:    isDark ? 'Golden particles · Divine vibes' : 'Crimson glow · Dark atmosphere',
              value:   !isDark,
              accent:  accent,
              isDark:  isDark,
          ...
          _SettingsCard(isDark: isDark, children: [
            ...
            _DropdownRow<String>(
              ...
              desc: _quality == 'high' ? 'High (320kbps)' : _quality == 'medium' ? 'Medium (160kbps)' : 'Low (96kbps)',
            ...
            _Divider(isDark),
            _SliderRow(
              icon: Icons.swap_horiz_rounded, label: 'Crossfade: ${_crossfade.toInt()}s',
          ...
          _SettingsCard(isDark: isDark, children: [
            ListTile(
              ...
              title:   Text('Current Version: $_version',
                style: TextStyle(fontFamily:'Rajdhani', color: isDark ? AriseColors.demonText : AriseColors.angelText, fontWeight:FontWeight.w700)),
              subtitle: _updStatus != null
                  ? Text(_updStatus!, style: TextStyle(fontFamily:'Rajdhani', color: accent, fontSize:12))
              ...
              trailing: _checkingUpd
                  ...
                  : ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(backgroundColor: accent, padding: const EdgeInsets.symmetric(horizontal:12, vertical:6)),
                      child: const Text('Check', style: TextStyle(fontFamily:'Rajdhani', fontSize:12)),
                    ),
            ),
          ]),
          const SizedBox(height: 16),
          ...
          _SettingsCard(isDark: isDark, children: [
            _ActionRow(
              ...
              onTap: () => _confirm('Clear History?', 'This removes all recently played tracks.', () => lib.clearHistory()),
            ),
            _Divider(isDark),
            _ActionRow(
              ...
              accent: accent, isDark: isDark, danger: true,
              onTap: () => _confirm('Clear Liked Songs?', 'All liked songs will be removed.', () {}),
            ),
          ]),
          const SizedBox(height: 16),
          ...
          _SettingsCard(isDark: isDark, children: [
            ListTile(
              leading: Text(isDark ? '🔥' : '✨', style: const TextStyle(fontSize: 22)),
              title: Text('Arise Music v$_version',
                style: TextStyle(fontFamily:'Orbitron', color: isDark ? AriseColors.demonText : AriseColors.angelText, fontSize:13, fontWeight:FontWeight.w700)),
              subtitle: Text(
                isDark ? 'Rise from the Shadows · JioSaavn + YouTube' : 'Hear the Divine · JioSaavn + YouTube',
                style: TextStyle(fontFamily:'Rajdhani', color: isDark ? AriseColors.demonMuted : AriseColors.angelMuted, fontSize:12)),
            ),
          ]),
...
class _SectionLabel extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Padding(
    ...
    child: Text(label, style: TextStyle(
      fontFamily:'Orbitron', fontSize:10, letterSpacing:.2, fontWeight:FontWeight.w700,
...
class _SwitchRow extends StatelessWidget {
  ...
  const _SwitchRow({required this.icon, required this.label, required this.desc,
    required this.value, required this.isDark, required this.accent, required this.onChanged});
...
class _DropdownRow<T> extends StatelessWidget {
  ...
  Widget build(BuildContext context) => ListTile(
    ...
    trailing:DropdownButton<T>(
      value:value, items:items, onChanged:onChanged, underline:const SizedBox(),
      style: TextStyle(fontFamily:'Rajdhani',
        color: isDark ? AriseColors.demonText : AriseColors.angelText, fontSize:13),
...
class _SliderRow extends StatelessWidget {
  ...
  const _SliderRow({required this.icon, required this.label, required this.desc,
    required this.value, required this.min, required this.max, required this.divisions,
    required this.isDark, required this.accent, required this.onChanged});
  ...
  Widget build(BuildContext context) => Padding(
    ...
    child: Column(
      ...
      children: [
        Row(children:[
          Icon(icon, color:accent, size:20), const SizedBox(width:12),
...
class _ActionRow extends StatelessWidget {
  ...
  const _ActionRow({required this.icon, required this.label, required this.desc,
    required this.isDark, required this.danger, required this.accent, required this.onTap});

  @override
  Widget build(BuildContext context) => ListTile(
    leading: Icon(icon, color: danger ? Colors.redAccent : accent),
    title:   Text(label, style: TextStyle(fontFamily:'Rajdhani',
      color: danger ? Colors.redAccent : (isDark ? AriseColors.demonText : AriseColors.angelText),
...
class _InfoRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Padding(
    ...
    child: Row(children:[
      Text('$label: ', style: const TextStyle(fontFamily:'Rajdhani', fontWeight:FontWeight.w700, fontSize:13)),
...
class _StatCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: Column(mainAxisAlignment: MainAxisAlignment.center, children:[
      ...
      const SizedBox(height:4),
      Text(value, style: TextStyle(fontFamily:'Orbitron', color:color, fontSize:18, fontWeight:FontWeight.w900)),
      Text(label, style: TextStyle(fontFamily:'Orbitron', color: isDark ? AriseColors.demonMuted : AriseColors.angelMuted, fontSize:9, letterSpacing:.1)),
    ]),
  );
}
